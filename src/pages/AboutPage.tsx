    ...
    <div className="min-h-screen bg-pure-white">
      ...
      <section className="py-8 sm:py-12 md:py-16 lg:py-20 bg-pure-white">
        <div className="max-w-4xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="space-y-3 sm:space-y-4 md:space-y-6 text-text-gray text-sm font-manrope sm:text-base md:text-lg leading-relaxed">
      ...
      <section className="py-8 sm:py-12 md:py-16 lg:py-20 bg-pure-white">
        <div className="max-w-4xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          ...
          <div className="space-y-4 sm:space-y-6 md:space-y-8 text-text-gray font-manrope text-sm sm:text-base md:text-lg leading-relaxed">
            <p className="animate-fade-in">
...
Founder with a passion for health, entrepreneurship, and community well-being. From Chhattisgarh, Siddharth identified the gap between farm produce and consumers and built Apna Fruit Box to bridge that gap with quality and purpose.
      ...
      <section className="py-8 sm:py-12 md:py-16 lg:py-20 bg-brand-primary relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 text-center">
          ...
          <p className="text-sm font-urbanist sm:text-base md:text-lg lg:text-xl mb-4 sm:mb-6 md:mb-8 leading-relaxed text-link-light">
