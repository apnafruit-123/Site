    ...
    <div className="min-h-screen bg-white text-black">
                    ...
                    <div key={`${s.key}-${idx}`} className="flex-shrink-0 w-screen h-full">
                      <div className={`grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 items-center h-full py-6 px-3 sm:px-4 md:py-12`}>
                        <div className="md:col-span-1 text-center md:text-left flex flex-col justify-center">
                          ...
                          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-archivo mb-2 sm:mb-3 text-slate-900" style={{ letterSpacing: '-0.02em' }}>
                            {s.title}
                          </h2>
                          <p className="text-sm sm:text-base md:text-lg text-slate-700 font-poppins font-bold max-w-lg mb-4 sm:mb-6 line-clamp-3">{s.subtitle}</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            <div>
              ...
              <div className="flex items-center gap-6 mb-6">
                ...
                <p className="font-bold font-poppins text-black mb-6">
      ...
      <section className="py-8 sm:py-12 md:py-16 lg:py-20 bg-brand-primary relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 text-center">
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl mb-4 sm:mb-6 md:mb-8 leading-relaxed font-urbanist text-white max-w-2xl mx-auto">
